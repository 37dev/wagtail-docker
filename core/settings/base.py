...
TEMPLATES = [
    {
        ...
        # since allauth template folder is an override, it must be explicit declared
...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL", default="django-base <noreply@basedomain.com>"
)
...
EMAIL_SUBJECT_PREFIX = env(
    "EMAIL_SUBJECT_PREFIX", default="[django-base]"
)
...
WAGTAIL_SITE_NAME = env("WAGTAIL_SITE_NAME", default="Site Name")
